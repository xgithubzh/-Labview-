...
<Project Type="Project" LVVersion="14008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="FFT滤波.vi" Type="VI" URL="../FFT滤波.vi"/>
		<Item Name="FFT滤波无mat程序版.vi" Type="VI" URL="../FFT滤波无mat程序版.vi"/>
		<Item Name="Frequency Analysis of a Filter Design.vi" Type="VI" URL="/E/LabVIEW2014/examples/Signal Processing/Waveform Measurements/Frequency Analysis of a Filter Design.vi"/>
		<Item Name="LSCE1.vi" Type="VI" URL="../LSCE1.vi"/>
		<Item Name="波形倍数.vi" Type="VI" URL="../波形倍数.vi"/>
		<Item Name="采集通道设置.vi" Type="VI" URL="../采集通道设置.vi"/>
		<Item Name="测试4.vi" Type="VI" URL="../../测试4.vi"/>
		<Item Name="获得信号的最大幅值及对应的相位和频率.vi" Type="VI" URL="../获得信号的最大幅值及对应的相位和频率.vi"/>
		<Item Name="获取波形子集.vi" Type="VI" URL="../获取波形子集.vi"/>
		<Item Name="界面3.vi" Type="VI" URL="../界面3.vi"/>
		<Item Name="模态参数提取（修改的）.vi" Type="VI" URL="../模态参数提取（修改的）.vi"/>
		<Item Name="模态分析使用版2.vi" Type="VI" URL="../模态分析使用版2.vi"/>
		<Item Name="平均计算FRF.vi" Type="VI" URL="../平均计算FRF.vi"/>
		<Item Name="趋势项消除.vi" Type="VI" URL="../趋势项消除.vi"/>
		<Item Name="软触发子程序.vi" Type="VI" URL="../软触发子程序.vi"/>
		<Item Name="设置选择.vi" Type="VI" URL="../设置选择.vi"/>
		<Item Name="设置选择2.vi" Type="VI" URL="../设置选择2.vi"/>
		<Item Name="整体正交拟合.vi" Type="VI" URL="../整体正交拟合.vi"/>
		<Item Name="阈值提醒.vi" Type="VI" URL="../阈值提醒.vi"/>
		<Item Name="依赖关系" Type="Dependencies">
			...
			<Item Name="波形数据的均值化2.vi" Type="VI" URL="../波形数据的均值化2.vi"/>
			<Item Name="单个均值化.vi" Type="VI" URL="../单个均值化.vi"/>
			<Item Name="单面配重.vi" Type="VI" URL="../单面配重.vi"/>
			<Item Name="通道字符串转换数值常量2.vi" Type="VI" URL="../通道字符串转换数值常量2.vi"/>
			<Item Name="选择性通道波形显示.vi" Type="VI" URL="../选择性通道波形显示.vi"/>
			<Item Name="转速测量2.vi" Type="VI" URL="../转速测量2.vi"/>
		</Item>
